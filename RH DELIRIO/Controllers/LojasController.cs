...
namespace RH_DELIRIO.Controllers
{
    public class LojasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("descricaoAtual,descricaoAnterior,descricaoOriginal,sigla,razao_social,cnpj,inscricao_estadual,cod_amil,Id")] Lojas lojas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, Lojas lojas)
        {
            if (id != lojas.Id)
            {
                return NotFound();
