...
namespace RH_DELIRIO.Data.Migrations
{
    ...
    [Migration("20220501234534_FixFuncionarios")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RH_DELIRIO.Models.EnderecoFuncionario", b =>
                {
                    ...
                    b.Property<Guid>("UnidadeDeFederacaoId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RH_DELIRIO.Models.EnderecoFuncionario", b =>
                {
                    ...
                    b.HasOne("RH_DELIRIO.Models.UnidadeDeFederacao", "UnidadeDeFederacao")
                        .WithMany()
                        .HasForeignKey("UnidadeDeFederacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RH_DELIRIO.Models.Funcionario", b =>
                {
                    b.HasOne("RH_DELIRIO.Models.Cargos", "Cargos")
                        .WithMany()
                        .HasForeignKey("CargosId1");
                    ...
                    b.HasOne("RH_DELIRIO.Models.UnidadeDeFederacao", null)
                        .WithMany("Funcionario")
                        .HasForeignKey("UnidadeDeFederacaoId");
